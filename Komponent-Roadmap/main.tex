...
* DevOps tankegangen er et strålende bud på en løsnining af 3 delingen mellem infrastruktur, drift og udvikling.
...
\subsection{Midas}
\begin{figure}[h]
\includegraphics[width=300pt]{Midas.PNG}
...
\subsection{Scanpix}
\begin{figure}[h]
\includegraphics[width=200pt]{Scanpix.PNG}
...
\subsection{WebCMS}
\begin{figure}[h]
\includegraphics[height=160pt]{WebCMS.PNG}
...
\begin{figure}[h]
\includegraphics[width=300pt]{DRSearch.PNG}
