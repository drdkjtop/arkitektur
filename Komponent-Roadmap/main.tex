...
Udarbejdelse af første udgave af datamodellen vil formentligt tage 3 mandeuger.
...
% Fælles deploy pipeline på tværs af teams
% Velkendt systemlandskab i huset og genkendelige systemer for nye ansatte
% Opdeling af ansvar for platform, instans og program
