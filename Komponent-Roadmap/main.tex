...
% Beskrivelse af Platform Services, Product Services, Content Services, Content Sources og Frontend Products


%\section{Ordforklaring}
% TODO Skriv ind hvad der menes med målarkitektur / referencearkitektur og andre drilske ord.
% Indsæt målarkitekturen, beskriv de forskellige lag, deres SLA, og adherence til Gartners Pace Layered application strategy.
...
%Ja. Ifølge dokumentationen... Om den er korrekt kan jeg kun håbe på
\subsubsection*{Anbefalet handling}
